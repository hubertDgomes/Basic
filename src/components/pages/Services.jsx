...
const Services = () => {
  ...
  return (
    <>
      <ScrollStack>
        <h1 className="text-5xl text-center font-Karla">I will Do</h1>
        <ScrollStackItem>
          <h2 className="text-center text-[40px] font-Karla font-bold">
            Web Design
          </h2>
          <p className="font-Inter text-[17px] mt-[20px]">
            Hubert is a leading web design agency with an award-winning design
          ...
          <p className="font-Inter text-[17px] mt-[20px]">
            ...
            design but also partnering with Hubert, the web design agency that’s
